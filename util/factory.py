...
from .pretrained import OPENAI_DATASET_MEAN, OPENAI_DATASET_STD
from models.model import CLIP, CustomTextCLIP, convert_weights_to_lp, convert_to_custom_text_state_dict,\
    resize_pos_embed, get_cast_dtype, resize_text_pos_embed, set_model_preprocess_cfg
from models.coca_model import CoCa
from .loss import ClipLoss, DistillClipLoss, CoCaLoss, SigLipLoss
from .openai import load_openai_model
from .pretrained import is_pretrained_cfg, get_pretrained_cfg, download_pretrained,\
    list_pretrained_tags_by_model, download_pretrained_from_hf
from datasets.transform import image_transform_v2, AugmentationCfg, PreprocessCfg, merge_preprocess_dict, merge_preprocess_kwargs
    ...
    if pretrained and pretrained.lower() == 'openai':
        ...
        if precision in ("fp16", "bf16"):
            ...
            if is_timm_model:
                ...
                from models.transformer import LayerNormFp32
